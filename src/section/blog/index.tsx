     ...
     <BlogFilter />
      <div className="flex mb-10 flex-wrap gap-y-4 gap-[calc(4%/3)]">
        {data.length ? data.map((blog) => (
          ...
          className="flex flex-col shadow-lg border border-collapse max-h-[250px] h-[250px] rounded-lg overflow-hidden bg-primary-item w-[24%]">
          <div className="p-4 pb-0 flex flex-col gap-2">
            ...
            <p className="text-gray-600 h-[70px] overflow-hidden text-sm truncate w-full" 
            dangerouslySetInnerHTML={{ __html: blog.content }}
            ></p>
          </div>
          <div className="flex items-center min-h-[80px] h-[80px] p-4 border-t border-b-primary-root-background-table mt-auto">
