...
const QuizOverviewPage = ({ quiz }: Props) => {
    ...
    <WrapBox className=''>
      ...
      <div className=' flex gap-2  py-3'>
        <Link href={`/do-quiz/${quiz.quizId}`} className='bg-primary-background px-2  py-2 border rounded-md text-primary'>Làm bài</Link>
        <Link href={`/quiz/${quiz.quizId}/quiz-detail`} className='bg-primary-background px-3  py-2 border rounded-md text-primary'>
        Xem chi tiết đề
        </Link>
